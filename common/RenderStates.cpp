...
void RenderStates::InitAll(ID3D11Device* device)
{
    ...
    HR(device->CreateSamplerState(&samplerDesc, SSLinearWrap.GetAddressOf()));
    ...
    samplerDesc.MinLOD = 0;
    samplerDesc.MaxLOD = D3D11_FLOAT32_MAX;
    HR(device->CreateSamplerState(&samplerDesc, SSAnisotropicWrap.GetAddressOf()));
